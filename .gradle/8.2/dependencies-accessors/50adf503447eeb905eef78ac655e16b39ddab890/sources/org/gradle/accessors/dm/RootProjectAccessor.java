...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public LatinumProjectDependency getLatinum() { return new LatinumProjectDependency(getFactory(), create(":")); }

    /**
     * Creates a project dependency on the project at path ":LatinumApp"
     */
    public LatinumAppProjectDependency getLatinumApp() { return new LatinumAppProjectDependency(getFactory(), create(":LatinumApp")); }
